...
const GENERIC_TRANSACTION_KIND_ERROR_CODES = [
  'P0_INVALID_BASE64',
...
export const RELAY_SETTLEMENT_FUNDING_CHECK_ERROR_CODES = [
  ...HOST_REQUEST_ADMISSION_ERROR_CODES,
  'BAD_REQUEST',
  'REQUEST_BODY_TOO_LARGE',
  ...GENERIC_TRANSACTION_KIND_ERROR_CODES,
...
export type RelaySettlementFundingCheckErrorCode =
  (typeof RELAY_SETTLEMENT_FUNDING_CHECK_ERROR_CODES)[number];
